...
protected IASTexpression[] toExpressions(
		List<antlr4.ILPMLgrammar1tme2Parser.ExprContext> args) {
	if (args == null) return new IASTexpression[0];
	IASTexpression[] r = new IASTexpression[args.size()];
	int pos = 0;
	for (antlr4.ILPMLgrammar1tme2Parser.ExprContext e : args) {
		r[pos++] = e.node;
	}
	return r;
}
